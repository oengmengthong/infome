...
class AGRICULTUREScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => AGRICULTURE();
}

class AGRICULTURE extends State<AGRICULTUREScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('AGRICULTURE',style: TextStyle(fontSize: 20,color: Colors.teal,fontWeight: FontWeight.bold),),
