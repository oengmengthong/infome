...
class LAWScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => LAW();
}

class LAW extends State<LAWScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('LAW',style: TextStyle(fontSize: 20,color: Colors.teal,fontWeight: FontWeight.bold),),
