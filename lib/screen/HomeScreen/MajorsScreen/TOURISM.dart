...
class TOURISMScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => TOURISM();
}

class TOURISM extends State<TOURISMScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('TOURISM',style: TextStyle(fontSize: 20,color: Colors.teal,fontWeight: FontWeight.bold),),
