...
class ENGINEERINGScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => ENGINEERING();
}

class ENGINEERING extends State<ENGINEERINGScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('ENGINEERING',style: TextStyle(fontSize: 20,color: Colors.teal,fontWeight: FontWeight.bold),),
