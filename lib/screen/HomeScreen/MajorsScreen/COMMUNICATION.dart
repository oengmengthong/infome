...
class COMMUNICATIONScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => COMMUNICATION();
}

class COMMUNICATION extends State<COMMUNICATIONScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('COMMUNICATION',style: TextStyle(fontSize: 20,color: Colors.teal,fontWeight: FontWeight.bold),),
