...
class BUSINESSScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BUSINESS();
}

class BUSINESS extends State<BUSINESSScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('BUSINESS',style: TextStyle(fontSize: 20,color: Colors.teal,fontWeight: FontWeight.bold),),
