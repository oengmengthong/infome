...
class ARTANDMUSICScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => ARTANDMUSIC();
}

class ARTANDMUSIC extends State<ARTANDMUSICScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('ART AND MUSIC',style: TextStyle(fontSize: 20,color: Colors.teal,fontWeight: FontWeight.bold),),
