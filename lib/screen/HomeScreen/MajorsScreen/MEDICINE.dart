...
class MEDICINEScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => MEDICINE();
}

class MEDICINE extends State<MEDICINEScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('MEDICINE',style: TextStyle(fontSize: 20,color: Colors.teal,fontWeight: FontWeight.bold),),
