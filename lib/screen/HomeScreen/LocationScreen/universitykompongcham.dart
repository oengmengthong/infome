...
class ListUniversityKampongChamScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => University();
}

class University extends State<ListUniversityKampongChamScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('Kampong Cham',style: TextStyle(fontSize: 20,color: Colors.teal,fontWeight: FontWeight.bold),),
