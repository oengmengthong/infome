...
class ListUniversityKompotScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => University();
}

class University extends State<ListUniversityKompotScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('Kompot',style: TextStyle(fontSize: 20,color: Colors.teal,fontWeight: FontWeight.bold),),
