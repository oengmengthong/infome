...
class ListUniversitySvayRiengScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => University();
}

class University extends State<ListUniversitySvayRiengScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('Svay Rieng',style: TextStyle(fontSize: 20,color: Colors.teal,fontWeight: FontWeight.bold),),
